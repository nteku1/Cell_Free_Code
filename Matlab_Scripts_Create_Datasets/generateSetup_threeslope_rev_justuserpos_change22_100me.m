function [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,UEpositions,distancesUE] = generateSetup_threeslope_rev_justuserpos_change22_100me(L,K,N,tau_p,nbrOfSetups,p,APpositions,UEpositions)
