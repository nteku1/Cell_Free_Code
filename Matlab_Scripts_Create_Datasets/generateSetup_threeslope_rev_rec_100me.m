function [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,APpositions,UEpositions,distancesUE] = generateSetup_threeslope_rev_rec_100me(L,K,N,tau_p,nbrOfSetups,p)
...
for n = 1:nbrOfSetups
    ...
    %APpositions = (200:100:400) + 1i*(200:100:400); 3 APs
%     APpositions = (50:50:250) + 1i*(50:50:250);
%10 APs     
%     APpositions = (5:10:95) + 1i*(5:10:95);
% 15 APs   APpositions = (50:25:400) + 1i*(50:25:400); %15
%20 APs 
   % APpositions = (4:4:80) + 1i*(4:4:80); %15
% 5 APs      APpositions = (50:75:400) + 1i*(50:75:400); %15
%25 APs     
    % APpositions = (3:3:75) + 1i*(3:3:75); %15
%50 APs
    APpositions = (1:50) + 1i*(1:50);
    ...
    for k = 1:K
        ...
        gainOverNoisedB(:,k,n) = pathloss_threeslope_rev(distancesUE(:,k,n)) - noiseVariancedBm;
...
%         gainOverNoisedB(:,k,n) = gainOverNoisedB(:,k,n) + sqrt(delta)*a(:) + sqrt(1-delta)*b(k);
