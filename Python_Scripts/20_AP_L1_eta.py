...
file1 = open('best_vvvver1_endfortoday__1_29_20APs_Single_Path_loss.txt','r')
...
num_APs = 20
num_user = 6
num_exclude = 18 #17 #18 #how many of the alphas to ignore. e.g. for 10 APs and num_exlcude = 7, will keep top 3 highest alphas
pos = 0
raw_iq = []
complex_vec = []
complex_vec_total = []
...
def nn_init():
    state_input = layers.Input(shape=(num_states)) #128,64 12000??
    out = layers.Dense(128, activation="swish",use_bias=False,kernel_regularizer='l2')(state_input) #128  64 swish  so far 128 mish
    #out =layers.Dropout(0.3) (out)
    out = layers.Dense(64, activation="tanh",use_bias=False,kernel_regularizer='l2')(out) #64  32 swish  so far 64 tanh
    #out =layers.Dropout(0.3) (out)
...
cell_nn_lr = 0.00002 #learning rate 0.000002  0.00002
...
for ep in range(total_episodes):
    ...
    while indexxx < 200 + 200*500:
        ...
        if indexxx == 66000:#42000:#####66000:#90000:#36900:#24000:#12000:#16632:#24000:#12000:#32004:  #TODO: try lower than 12000
            stop_now = 1
            break
...
file2 = open('best_vvvver1_endfortoday__1_29_20APs_Single_Path_loss_p2.txt','r')
...
min_interior_cdf = [0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00500501, 0.02502503, 0.05505506, 0.08308308, 0.10910911, 0.13613614, 0.17017017, 0.20120120, 0.23323323, 0.27127127, 0.30430430, 0.32932933, 0.35835836, 0.39239239, 0.41741742, 0.44244244, 0.45945946, 0.48848849, 0.50850851, 0.52052052, 0.54054054, 0.55055055, 0.56156156, 0.56756757, 0.57657658, 0.58758759, 0.59359359, 0.60660661, 0.61761762, 0.62562563, 0.63163163, 0.63863864, 0.65065065, 0.65765766, 0.66466466, 0.67167167, 0.67767768, 0.68568569, 0.69169169, 0.69569570, 0.70570571, 0.71171171, 0.71771772, 0.72272272, 0.72872873, 0.73173173, 0.73273273, 0.74174174, 0.75075075, 0.75575576, 0.76076076, 0.76476476, 0.76876877, 0.77277277, 0.77677678, 0.78178178, 0.78578579, 0.79179179, 0.79279279, 0.79779780, 0.80280280, 0.80980981, 0.81281281, 0.81281281, 0.81581582, 0.82182182, 0.82282282, 0.82282282, 0.82482482, 0.82582583, 0.82782783, 0.82882883, 0.83083083, 0.83283283, 0.83583584, 0.83683684, 0.83883884, 0.84284284, 0.84684685, 0.84784785, 0.84784785, 0.84784785, 0.84784785, 0.85085085, 0.85185185, 0.85285285, 0.85785786, 0.86186186, 0.86486486, 0.86586587, 0.86986987, 0.87087087, 0.87387387, 0.87387387, 0.87687688, 0.87787788, 0.87987988, 0.88088088, 0.88288288, 0.88388388, 0.88388388, 0.88388388, 0.88388388, 0.88788789, 0.88888889, 0.88988989, 0.88988989, 0.89189189, 0.89189189, 0.89489489, 0.89489489, 0.89789790, 0
 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96296296, 0.96296296, 0.96296296, 0.96296296, 0.96296296, 0.96296296, 0.96296296, 0.96296296, 0.96396396, 0.96396396, 0.96396396, 0.96396396, 0.96396396, 0.96396396, 0.96396396, 0.96396396, 0.96496496, 0.96496496, 0.96496496, 0.96496496, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96596597, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96696697, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96896897, 0.96996997, 0.96996997, 0.96996997, 0.96996997, 0.96996997, 0.96996997, 0.96996997, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97197197]
min_sqp = [0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00200200, 0.00400400, 0.01701702, 0.03503504, 0.06606607, 0.11811812, 0.17517518, 0.23923924, 0.30630631, 0.38138138, 0.45345345, 0.52052052, 0.56356356, 0.61061061, 0.65465465, 0.69769770, 0.74174174, 0.77177177, 0.78878879, 0.80680681, 0.83083083, 0.84284284, 0.85085085, 0.86886887, 0.87787788, 0.89089089, 0.89789790, 0.90190190, 0.90790791, 0.91191191, 0.91791792, 0.92392392, 0.92792793, 0.93293293, 0.93493493, 0.94094094, 0.94394394, 0.94894895, 0.95195195, 0.95295295, 0.95295295, 0.95595596, 0.95695696, 0.95695696, 0.95795796, 0.95895896, 0.96096096, 0.96396396, 0.96496496, 0.96596597, 0.96696697, 0.96796797, 0.96796797, 0.96796797, 0.96896897, 0.96896897, 0.97197197, 0.97197197, 0.97197197, 0.97197197, 0.97297297, 0.97397397, 0.97397397, 0.97397397, 0.97397397, 0.97397397, 0.97397397, 0.97397397, 0.97397397, 0.97497497, 0.97597598, 0.97697698, 0.97697698, 0.97697698, 0.97697698, 0.97697698, 0.97697698, 0.97697698, 0.97797798, 0.97797798, 0.97897898, 0.97897898, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98198198, 0.98298298, 0.98298298, 0.98298298, 0.98298298, 0.98298298, 0.98398398, 0.98498498, 0.98498498, 0.98498498, 0.98498498, 0.98498498, 0.98498498, 0.98498498, 0.98598599, 0.98598599, 0.98598599, 0.98598599, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98698699, 0.98798799, 0.98798799, 0.98798799, 0.98798799, 0.98798799, 0.98798799, 0.98998999, 0.98998999, 0.98998999, 0.98998999, 0.98998999, 0.98998999, 0.98998999, 0.98998999, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99299299, 0.99299299, 0.99299299, 0.99299299, 0.99299299, 0.99299299, 0.99299299, 0.99299299, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600]

#Generating CDF results of neural network, uniform, and greedy methods.
stats22 = np.arange(0, 0.5, 0.001)
...
plt.title('Comparison under $L_{1}^{Max}$ - 20 APs & 6 UEs')
plt.xlabel("Max Latency (ms)")
plt.ylabel("CDF")
plt.legend(['MPA-NN [This Paper]', 'Uniform Allocation', 'Greedy Allocation','Centralized Method [IP]','Centralized Method [SQP]'],loc=5)
plt.grid()
plt.show()
