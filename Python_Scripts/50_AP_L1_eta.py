...
file1 = open('gggetready_faaaaa1_29_50APs_singlepathloss.txt','r')
...
num_APs = 50
num_user = 6
num_exclude = 48 #how many of the alphas to ignore. e.g. for 10 APs and num_exlcude = 7, will keep top 3 highest alphas
pos = 0
raw_iq = []
complex_vec = []
complex_vec_total = []
...
def nn_init():
    ...
    out = layers.Dense(10, activation="tanh",kernel_regularizer='l1_l2')(state_input) #10 tanh
    out = layers.Dense(400, activation="swish",kernel_regularizer='l1_l2')(out) # 300 swish
...
cell_nn_lr = 0.00002 #learning rate
...
file2 = open('ggggetready_faaaaa1_29_50APs_singlepathloss_p2.txt','r')
...
min_interior_cdf = [0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00400400, 0.03303303, 0.09709710, 0.18218218, 0.25125125, 0.30630631, 0.34934935, 0.39339339, 0.43843844, 0.47147147, 0.50450450, 0.53653654, 0.55955956, 0.58358358, 0.60960961, 0.62562563, 0.63663664, 0.65065065, 0.66466466, 0.67867868, 0.69969970, 0.72172172, 0.73073073, 0.74574575, 0.75275275, 0.76376376, 0.77777778, 0.78678679, 0.79379379, 0.79779780, 0.80980981, 0.81381381, 0.82082082, 0.82782783, 0.83183183, 0.83783784, 0.84184184, 0.85085085, 0.85285285, 0.85485485, 0.85685686, 0.86486486, 0.87087087, 0.87387387, 0.87687688, 0.87787788, 0.88388388, 0.88588589, 0.88688689, 0.89089089, 0.89289289, 0.89389389, 0.89489489, 0.89789790, 0.90090090, 0.90090090, 0.90190190, 0.90390390, 0.90490490, 0.90690691, 0.90790791, 0.91091091, 0.91391391, 0.91491491, 0.91691692, 0.91791792, 0.91791792, 0.91891892, 0.92192192, 0.92192192, 0.92192192, 0.92192192, 0.92392392, 0.92392392, 0.92692693, 0.92892893, 0.93093093, 0.93393393, 0.93593594, 0.93593594, 0.93793794, 0.93793794, 0.93993994, 0.94194194, 0.94394394, 0.94394394, 0.94594595, 0.94794795, 0.94894895, 0.94894895, 0.95195195, 0.95295295, 0.95395395, 0.95495495, 0.95495495, 0.95595596, 0.95695696, 0.95695696, 0.95695696, 0.95795796, 0.95895896, 0.95895896, 0.95895896, 0.96096096, 0.96096096, 0.96096096, 0.96096096, 0.96196196, 0.96196196, 0.96196196, 0.96196196, 0.96496496, 0.96496496, 0.96696697, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96796797, 0.96896897, 0.96896897, 0.96896897, 0.96996997, 0.96996997, 0.96996997, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97097097, 0.97297297, 0.97297297, 0.97397397, 0.97397397, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97597598, 0.97597598, 0.97597598, 0.97797798, 0.97897898, 0.97897898, 0.97897898, 0.97897898, 0.97997998, 0.97997998, 0.97997998, 0.97997998, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98098098, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, 0.98198198, ]

min_sqp = [0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.01301301, 0.04704705, 0.07307307, 0.13013013, 0.19019019, 0.27427427, 0.34034034, 0.42342342, 0.49249249, 0.56456456, 0.61961962, 0.67967968, 0.73773774, 0.77777778, 0.81181181, 0.83483483, 0.86086086, 0.87787788, 0.89189189, 0.90190190, 0.91391391, 0.91591592, 0.92092092, 0.92992993, 0.93193193, 0.93693694, 0.94494494, 0.94994995, 0.95695696, 0.96196196, 0.96296296, 0.96396396, 0.96696697, 0.96796797, 0.96896897, 0.96896897, 0.96996997, 0.96996997, 0.97197197, 0.97397397, 0.97497497, 0.97497497, 0.97497497, 0.97497497, 0.97697698, 0.97897898, 0.97997998, 0.98198198, 0.98398398, 0.98498498, 0.98498498, 0.98498498, 0.98598599, 0.98698699, 0.98798799, 0.98898899, 0.99099099, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99199199, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99399399, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99499499, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99599600, 0.99699700, 0.99699700, 0.99699700, 0.99699700, 0.99699700, 0.99699700, 0.99699700, 0.99699700, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800, 0.99799800]
...
plt.title('Comparison under $L_{1}^{Max}$ - 50 APs & 6 UEs')
